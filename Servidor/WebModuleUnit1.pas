...
uses
  ...
  Datasnap.DSHTTP, DS.View.Entidade.Pessoa, System.JSON, Data.DBXCommon,
  Data.DBXPlatform, DS.View.Entidade.Endereco;
...
type
  TWebModule1 = class(TWebModule)
    ...
    ServerEntidadeEndereco: TDSServerClass;
    ...
    procedure DSRESTWebDispatcher1FormatResult(Sender: TObject;
      ...
      var Handled: Boolean);
    procedure ServerEntidadeEnderecoGetClass(DSServerClass: TDSServerClass; var PersistentClass: TPersistentClass);
  private
...
procedure TWebModule1.ServerEntidadeEnderecoGetClass(DSServerClass: TDSServerClass; var PersistentClass: TPersistentClass);
begin
  PersistentClass := DS.View.Entidade.Endereco.TEndereco;
end;

procedure TWebModule1.ServerEntidadeProdutoGetClass(
  DSServerClass: TDSServerClass; var PersistentClass: TPersistentClass);
begin
  PersistentClass := DS.View.Entidade.Pessoa.TPessoa;
end;
